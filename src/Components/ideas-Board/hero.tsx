const Idea_BasedInfo= () => {
    return (

        <div className="bg-[url('/images/image18.png')] h-195 bg-cover bg-no-repeat w-full bg-[center_top] flex xl:justify-end lg:justify-center md:justify-center sm:justify-center items-center px-6 py-9">
            <div className="bg-[#255179]/83 max-w-[36rem] w-full p-6 xl:me-66 xl:py-14 xl:px-15 lg:py-16 lg:px-15 md:px-10 md:py-13">
                <p className="text-[#178FC7] mt-3 font-semibold text-lg">
                    What Can We Do?
                </p>
