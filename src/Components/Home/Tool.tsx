      ...
      <div className="xl:px-25 lg:px-25 md:px-13 sm:px-10 px-8 py-16 xl:py-32 lg:py-27 md:py-23 sm:py-19 max-w-5xl mx-auto">
        {toolsData.map((item, index) => (
          <div key={index} className=" max-w-[700px]">
            <p className="sm:text-lg text-md font-semibold text-[#1898D8]">{item.text1}</p>
            <p className="text-[24px] xl:text-[42px] lg:text-[42px] md:text[38px] sm-text[32px] font-semibold leading-tight text-[#235380]">{item.Heading1}</p>
